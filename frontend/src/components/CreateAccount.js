...
function CreateAccount() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const accountData = {
        ...
        initial_balance: formData.initial_balance ? dollarsTocents(formData.initial_balance) : 0,
  ...
  return (
    <div className="card">
      <h2 style={{ marginBottom: '2rem', color: '#1f2937' }}>➕ Create New Account</h2>
      ...
      {createdAccount && (
        <div className="success" style={{ marginBottom: '2rem' }}>
          ...
          <div style={{ marginTop: '1rem' }}>
            <strong>Account Number:</strong> {createdAccount.account_number}<br />
            <strong>Account ID:</strong> {createdAccount.id}<br />
            <strong>Name:</strong> {createdAccount.name}<br />
            <strong>Balance:</strong> {(createdAccount.balance / 100).toFixed(2)} {createdAccount.currency}<br />
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          ...
          />
          <small style={{ color: '#6b7280', fontSize: '0.875rem' }}>
            Enter amount in dollars (e.g., 1000.50). Leave empty for $0.00 initial balance.
          </small>
        </div>
      ...
      <div style={{ marginTop: '2rem', padding: '1rem', backgroundColor: '#f8fafc', borderRadius: '8px' }}>
        ...
        <ul style={{ color: '#6b7280', fontSize: '0.875rem', paddingLeft: '1.5rem' }}>
          ...
          <li>All monetary amounts are stored securely to prevent rounding errors</li>
